...
namespace QueueSimulationTests
{
    class AddPatientsToDB
    {
        ...
        public void Add_Patient_Red(int patientCount)
        {
            ...
            for (int i = 0; i < patientCount; i++)
            {
                ...
                var Disability = 4;
                var Temperatura = (Math.Round(random.NextDouble() * (43 - 41) + 41, 1)).ToString();
        ...
        public void Add_Patient_Orange(int patientCount)
        {
            string[] name = { "Ania", "Anita", "Adam", "Adriam", "Bartosz", "Bartłmiej", "Barbara", "Bianka", "Celina", "Cycylia", "Czesław" };
            string[] surname = { "Kowalski", "Wybicki", "Lama", "Nowak", "Kruszek", "Fretowski", "Gołebiowski" };
            Random random;
        ...
        public void Add_Patient_Yellow(int patientCount)
        {
            string[] name = { "Ania", "Anita", "Adam", "Adriam", "Bartosz", "Bartłmiej", "Barbara", "Bianka", "Celina", "Cycylia", "Czesław" };
            string[] surname = { "Kowalski", "Wybicki", "Lama", "Nowak", "Kruszek", "Fretowski", "Gołebiowski" };
            Random random;
            ...
            for (int i = 0; i < patientCount; i++)
            {
                ...
                var CisnienieKrwi = random.Next(100, 110);
                var Disability = 2;
                var Temperatura = (Math.Round(random.NextDouble() * (40 - 37) + 37, 1)).ToString();
        ...
        public void Add_Patient_Green(int patientCount)
        {
            string[] name = { "Ania", "Anita", "Adam", "Adriam", "Bartosz", "Bartłmiej", "Barbara", "Bianka", "Celina", "Cycylia", "Czesław" };
            string[] surname = { "Kowalski", "Wybicki", "Lama", "Nowak", "Kruszek", "Fretowski", "Gołebiowski" };
            Random random;
            ...
            for (int i = 0; i < patientCount; i++)
            {
                ...
                var CisnienieKrwi = random.Next(100, 110);
                var Disability = 1;
                var Temperatura = (Math.Round(random.NextDouble() * (36 - 35) + 35, 1)).ToString();
    ...
    class AddPatientMixed
    {
        public void Add_Patient_Red()
        {

        }

        public void Add_Patient_Orange()
        {

        }

        public void Add_Patient_Yellow()
        {

        }

        public void Add_Patient_Green()
        {
